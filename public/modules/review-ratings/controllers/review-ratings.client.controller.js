...
angular.module('review-ratings').controller('ReviewRatingsController', ['$scope', '$stateParams', '$location','User', 'Authentication','Message', 'ReviewRatings',
  function($scope, $stateParams, $location,User, Authentication,Message, ReviewRatings) {
    $scope.user = User.get();
